  ...
  <div class="col-span-12 lg:col-span-6 xl:col-span-3 card-container">
    <div class="card mb-0">
      <div class="flex justify-between mb-4">
        ...
        <div
          class="flex items-center justify-center bg-blue-100 dark:bg-blue-400/10 rounded-border border border-gray-200"
  ...
  <div class="col-span-12 lg:col-span-6 xl:col-span-3 card-container">
    <div class="card mb-0">
      <div class="flex justify-between mb-4">
        ...
        <div
          class="flex items-center justify-center bg-orange-100 dark:bg-orange-400/10 rounded-border border border-gray-200"
          style="width: 2.5rem; height: 2.5rem"
        >
  ...
  <div class="col-span-12 lg:col-span-6 xl:col-span-3 card-container">
    <div class="card mb-0">
      <div class="flex justify-between mb-4">
        ...
        <div
          class="flex items-center justify-center bg-cyan-100 dark:bg-cyan-400/10 rounded-border border border-gray-200"
          style="width: 2.5rem; height: 2.5rem"
        >
